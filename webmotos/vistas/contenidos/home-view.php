...
<div>
    ...
    <div class=" w-full px-2 space-y-3">
        ...
        <div class="bg-gray-50 rounded-md border mt-2 p-1">
            <h1 class="text-lg font-semibold text-red-600"> <i class="fa fa-star" aria-hidden="true"></i>
                Recomendacion exclusiva para ti <span
                    class="text-xs border rounded-lg text-white bg-red-500 px-2"><?php echo $_SESSION['SRM_Experiencia'] ?></span>
                <span
                    class="text-xs border rounded-lg text-white bg-red-500 px-2"><?php echo $_SESSION['SRM_tipoUso'] ?></span>
            </h1>
            <hr>
            <div class="flex overflow-x-auto w-full">
                <?php
        ...
        <div class="bg-gray-50 rounded-md border mt-2 p-1">
            <h1 class="text-lg font-semibold text-red-600"> <i class="fa fa-star" aria-hidden="true"></i>
                Más recomendaciones para ti <span
                    class="text-xs border rounded-lg text-white bg-red-500 px-2"><?php echo $_SESSION['SRM_Experiencia'] ?></span>
                <span
                    class="text-xs border rounded-lg text-white bg-red-500 px-2"><?php echo $_SESSION['SRM_tipoUso'] ?></span>
            </h1>
    ...
    <div class="w-full h-80 mt-2"
        style="background: url('<?= SERVERURL ?>vistas/assets/img/fondo.jpg') center top no-repeat fixed; background-size: cover;">
    </div>
